...
{
    public class ProtocolType : ProtocolItem
    {
        public ProtocolType()
        {
            this.Enum = new HashSet<string>();
            this.Properties = new HashSet<ProtocolProperty>();
        }
        ...
        public HashSet<ProtocolProperty> Properties
        {
            get;
            set;
        }

        public ProtocolType Items
        {
            get;
            set;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            equals &= ProtocolType.Equals(this.Items, other.Items);
