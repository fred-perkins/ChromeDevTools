...
{
    public class ProtocolCommand : ProtocolItem
    {
        public ProtocolCommand()
        {
            this.Returns = new Collection<ProtocolProperty>();
            this.Handlers = new Collection<string>();
            this.Parameters = new Collection<ProtocolProperty>();
        }

        public Collection<ProtocolProperty> Returns
        {
            get;
            set;
        }

        public ProtocolProperty Error
        {
            get;
            set;
        }
        ...
        {
            var other = obj as ProtocolCommand;
            ...
            equals &= ProtocolProperty.Equals(this.Error, other.Error);
        ...
        public ProtocolProperty GetParameter(string name)
        {
